...
void MenuState::draw() {
	...
	g_renderer->draw_text("Card Hell", g_renderer->width / 20, int(0.1f * g_renderer->height), 70, SDL_Color{ 255, 255, 255, 255 });
	g_renderer->draw_text("by Abscission", g_renderer->width - g_renderer->width / 10, int(0.9f * g_renderer->height), 20, SDL_Color{ 255, 255, 255, 255 });

	SDL_Rect play_hitbox = g_renderer->draw_text("Play", g_renderer->width / 20, int(0.85f * g_renderer->height), 20, SDL_Color{ 255, 255, 255, 255});
